var rule = {
  ...
  tab_exclude: '今日更新|APP|留言|硬核指南',
    ...
    double: true,
    推荐: '*',
一级: '.module-item;img&&alt;img&&data-original;.module-card-item-title&&Text;a&&href',
    二级: {
        "title": "h1&&a&&Text",
        ...
        "lists": ".module-play-list:eq(#id)&&a"
            ...
            搜索:'.module-item;img&&alt;img&&data-original;.module-card-item-title&&Text;a&&href',
        }