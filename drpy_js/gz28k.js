var rule = {
    ...
    lazy: $js.toString(() => {
        ...
        var html = fetch('https://api.5udaneqy.com/App/Resource/VurlDetail/showOne', {
            headers: {
                'Cache-Control': 'no-cache',
                'Version': '2406025',
                'PackageName': 'com.uf076bf0c246.qe439f0d5e.m8aaf56b725a.ifeb647346f',
                'Ver': '1.9.2',
                'Referer': 'https://api.5udaneqy.com',
                'X-Customer-Client-Ip': '127.0.0.1',
                'Content-Type': 'application/x-www-form-urlencoded',
                'Host': 'api.5udaneqy.com',
    ...
    一级: $js.toString(() => {
        ...
        var html2 = gethtml("https://api.5udaneqy.com/App/IndexList/indexList", body, headers)
    ...
    二级: $js.toString(() => {
        ...
        input = input.replace('https://api.5udaneqy.com/', '');
        ...
        var html = gethtml("https://api.5udaneqy.com/App/IndexPlay/playInfo", body, headers)
        ...
        var html3 = gethtml("https://api.5udaneqy.com/App/Resource/Vurl/show", body2, headers); //log(html3)
